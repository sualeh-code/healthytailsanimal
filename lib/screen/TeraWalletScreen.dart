...
class TeraWalletScreenState extends State<TeraWalletScreen> {
      ...
      bool isPaymentDone = await Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => WebViewPaymentScreen(
                    checkoutUrl: response['woocommerce_redirect'])),
          ) ??
          false;
      if (isPaymentDone) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: mTop(context, appLocalization.translate('lbl_wallet')!,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FutureBuilder<List<WalletResponse>>(
                      future:
                          getBalanceHistory != null ? getBalanceHistory! : null,
                      builder: (_, snap) {
                        if (snap.data.validate().isNotEmpty) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(appLocalization.translate("lbl_history")!,
                                      style: boldTextStyle())
                                  ...
                                  children: [
                                    ListView.separated(
                                      ...
                                      itemBuilder: (context, i) {
                                        return TeraWalletHistoryComponent(
                                            snap.data![i]);
                                      },
                                      separatorBuilder:
                          ...
                          return Column(
                            ...
                            children: [
                              Icon(MaterialCommunityIcons.emoticon_cry_outline,
                                  size: 120, color: context.iconColor),
                              8.height,
                              Text(appLocalization.translate("msg_no_money")!,
