...
class ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: mTop(context, appLocalization.translate('lbl_change_pwd'),
                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      EditText(
                          hintText:
                              appLocalization.translate('hint_old_password'),
                          isPassword: true,
                          isSecure: true,
                      ...
                      EditText(
                          ...
                          validator: (v) {
                            ...
                            if (!passwordCont.text
                                .toString()
                                .contains(newPasswordCont.text.toString()))
                              return appLocalization
                                  .translate('error_pwd_match');
                            return null;
                          }),
                      16.height,
                      AppButton(
