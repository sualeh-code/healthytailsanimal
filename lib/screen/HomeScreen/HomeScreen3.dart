...
class HomeScreen3State extends State<HomeScreen3> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget availableOfferAndDeal(
      ...
      return Stack(
        children: [
          commonCacheImageWidget(ic_horizontal_bg,
              height: 285, width: context.width(), fit: BoxFit.cover),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  HorizontalList(
                    padding:
                        EdgeInsets.only(left: context.width() * 0.3, right: 8),
                  ...
                  viewAllDashBoard3(context,
                          viewAll: builderResponse
                    ...
                    () {
                      if (title ==
                        ...
                        ViewAllScreen(appLocalization.translate('lbl_offer'),
                    ...
                    children: mSliderModel.map((i) {
                      return Container(
                        decoration: boxDecorationWithRoundedCorners(
                            ...
                            border: Border.all(
                                color:
                                    textSecondaryColorGlobal.withOpacity(0.4))),
                  ...
                  children: [
                    Container(
                      ...
                      child: commonCacheImageWidget(
                          mSaleBanner[i].image.validate(),
                          width: double.infinity,
                          fit: BoxFit.cover),
                    ).onTap(() {
                      SaleScreen(
                              startDate: mSaleBanner[i].startDate,
                              endDate: mSaleBanner[i].endDate,
                              title: mSaleBanner[i].title)
                          .launch(context);
                    }),
                    Container(
                        ...
                        children: [
                          ...
                          Text(
                              appLocalization
                                  ...
                                  " " +
                                  mSaleBanner[i].startDate.validate() +
                                  " to " +
                                  mSaleBanner[i].endDate.validate(),
                    ...
                    mSaleBanner[i].title!.isNotEmpty &&
                        mSaleBanner[i].image!.isNotEmpty);
              },
            )
          : SizedBox();
    }
      ...
      return DashboardComponent3(
        ...
        onTap: () {
          ViewAllScreen(builderResponse.dashboard!.youMayLikeProduct!.title,
                  isSpecialProduct: true, specialProduct: "you_may_like")
              .launch(context);
        },
      );
    }
        ...
        ListView.builder(
          ...
          itemBuilder: (_, index) {
            if (builderResponse.dashboard!.sorting![index] == 'slider') {
              ...
              return mVendorDashBoard3Widget(
                      context,
                      mVendorModel,
              ...
              return _offer()
                ...
                'suggested_for_you') {
              return _suggested().paddingTop(8).visible(
                  builderResponse.dashboard!.suggestionProduct!.enable!);
            } else if (builderResponse.dashboard!.sorting![index] ==
                'you_may_like') {
              return _youMayLike().paddingTop(8).visible(
