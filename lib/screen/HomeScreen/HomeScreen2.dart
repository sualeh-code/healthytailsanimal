...
class HomeScreenState extends State<HomeScreen2> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget availableOfferAndDeal(
        String title, String subtitle, List<ProductResponse> product) {
      return Stack(
        children: [
            ...
            children: [
                ...
                children: [
                  ...
                  Text(title,
                          style: GoogleFonts.alata(
                              fontSize: 24, color: context.iconColor))
                      .paddingOnly(left: 8),
                  8.width,
                  Container(height: 1.5, width: 24, color: context.iconColor),
                ],
              ...
              viewAll(() {
                if (title == builderResponse.dashboard!.dealOfTheDay!.title) {
                  ...
                  ViewAllScreen(MaxAdContentRating.t,
        ...
        ListView.builder(
          ...
          itemBuilder: (_, index) {
            if (builderResponse.dashboard!.sorting![index] == 'slider') {
              ...
              return mVendorDashBoard2Widget(
                      context,
                      mVendorModel,
