    ...
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: createRichText(
          ...
          list: [
            TextSpan(
                text: appLocalization.translate('lbl_already_have_account'),
              ...
              Form(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      50.height,
                      Text(appLocalization.translate('lbl_create_account')!,
                                ...
                                validator: (String? v) {
                                  if (v!.trim().isEmpty)
                                    return appLocalization
                                        .translate('error_first_name_required');
                                  if (!v.trim().isAlpha())
                                    return appLocalization
                          ...
                          Expanded(
                            child: EditText(
                                ...
                                validator: (String? v) {
                                  if (v!.trim().isEmpty)
                                    return appLocalization
                                        .translate('error_last_name_required');
                                  if (!v.trim().isAlpha())
                                    return appLocalization
                                        .translate('error_only_alphabet');
                                  return null;
