  ...
  Widget build(BuildContext context) {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                PriceWidget(
                    price: getTotalAmount(), size: 16, color: primaryColor),
              ],
            ),
            16.height,
          ],
                          ...
                          if (cartStore.isOutOfStock == false) {
                            if (cartStore.shippingMethodResponse != null &&
                              ...
                              if (cartStore.shippingMethodResponse != null &&
                                  cartStore.shippingMethods.isNotEmpty) {
                                method =
                                    cartStore.shippingMethods[selectedShipment];
                                shippingLine = ShippingLines(
                                    methodId: cartStore
                                        .shippingMethods[selectedShipment].id,
                                    methodTitle: cartStore
                                        .shippingMethods[selectedShipment]
                                        .methodTitle,
                                    total: cartStore
                                        .shippingMethods[selectedShipment]
                                        .cost);
    ...
    return Scaffold(
      appBar: mTop(context, appLocalization.translate('lbl_my_cart'),
          showBack: widget.isShowBack!, showCat: true) as PreferredSizeWidget?,
