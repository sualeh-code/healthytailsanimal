...
class ChooseDemoState extends State<ChooseDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: mTop(context, appLocalization.translate('lbl_multiple_demo'),
          showBack: true,
          actions: [
            IconButton(
                ...
                onPressed: () async {
                  ...
                  setState(() {
                    if (primaryColor != null) {
                      primaryColor = getColorFromHex(mPrimaryColor,
                          defaultColor: appColorPrimary);
                    } else {
                      primaryColor = getColorFromHex(
                          getStringAsync(PRIMARY_COLOR),
                          defaultColor: appColorPrimary);
                    }
                  });
                })
