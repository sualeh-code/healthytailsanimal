        ...
        itemBuilder: (context, i) {
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: <Widget>[
                  if (category[i].image != null)
                    commonCacheImageWidget(category[i].image!.src,
                        width: MediaQuery.of(context).size.width * 0.1,
                        fit: BoxFit.contain),
                  4.width,
                  Text(parseHtmlString(category[i].name.validate()),
                  ...
                  ? Column(
                      children: [
                        ...
                        InkWell(
                          ...
                          ).visible(appStore.count! > 0 &&
                              cartStore.cartTotalAmount > 0),
                        )
                      ],
                    )
                  : EmptyScreen().center().visible(errorMsg.isEmpty &&
