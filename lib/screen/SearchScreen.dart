                          ...
                          mAttributeModel.isNotEmpty
                              ? showModalBottomSheet(
                                  ...
                                  builder: (context) => FilterScreen(
                                      mAttributeModel, mTerms, (attribute) {
                                    setState(() {
                              ...
                              : toast(
                                  appLocalization.translate('lbl_attribute'));
                        },
          ...
          child: BodyCornerWidget(
            child: Stack(
              children: <Widget>[
                ...
                Center(child: EmptyScreen()).visible(mErrorMsg.isNotEmpty &&
                    !isLoading &&
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                        ...
                        child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              var selectedCount = 0;
                              widget.mAttributeModel[index].total =
                                  selectedCount;
                              return Container(
                    ...
                    Expanded(
                        flex: isMobile ? 5 : 7,
                        child: getCurrentList(selectedIndex))
                  ],
                )
              ],
            ),
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text(appLocalization.translate("action_filter")!,
                        style: boldTextStyle()),
                    Text(
                            appLocalization
                                .translate("lbl_clear_all")!
                                .toUpperCase(),
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    alignment: Alignment.center,
                    color: primaryColor,
                    child: Text(appLocalization.translate("lbl_apply")!,
