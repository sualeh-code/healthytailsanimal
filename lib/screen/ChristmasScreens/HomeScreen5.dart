...
class HomeScreen5State extends State<HomeScreen5> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget availableOfferAndDeal(
        String title, List<ProductResponse> product, String subtitle) {
      return Stack(
        children: [
          Image.asset(ic_christmas_horizontal,
              width: context.width(), height: 380, fit: BoxFit.cover),
          Column(
            children: [
              16.height,
              Row(
                ...
                Container(
                  ...
                  child: GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                        maxCrossAxisExtent: 240, childAspectRatio: 1.1),
    ...
    Widget carousel() {
      return mSliderModel.isNotEmpty
          ? Stack(
              ...
              children: [
                Image.asset(ic_christmas_banner,
                        height: 230, width: context.width(), fit: BoxFit.cover)
                ...
                Positioned(
                  ...
                  child: DotIndicator(
                          ...
                          unselectedIndicatorColor:
                              mChristmasColor.withOpacity(0.4),
                  ...
                  child: PageView(
                    ...
                    children: mSaleBanner.map((i) {
                      return Stack(
                        ...
                        overflow: Overflow.visible,
                        children: [
                          commonCacheImageWidget(i.image.validate(),
                          ...
                          .visible(i.title!.isNotEmpty && i.image!.isNotEmpty);
                    }).toList(),
                  ),
                ),
                DotIndicator(
    ...
    Widget _newProduct() {
      return DashboardComponent5(
        ...
        onTap: () {
          ViewAllScreen(builderResponse.dashboard!.newProduct!.title,
                  isNewest: true)
              .launch(context);
        },
      );
    ...
    Widget _bestSelling() {
      return DashboardComponent5(
        ...
        onTap: () {
          ViewAllScreen(builderResponse.dashboard!.bestSaleProduct!.title,
                  isNewest: true)
              .launch(context);
        },
      );
    ...
    Widget _saleProduct() {
      return DashboardComponent5(
        ...
        onTap: () {
          ViewAllScreen(builderResponse.dashboard!.saleProduct!.title,
                  isNewest: true)
              .launch(context);
        },
      );
    ...
    Widget _offer() {
      return availableOfferAndDeal(
              builderResponse.dashboard!.offerProduct!.title!,
              mOfferProductModel,
              builderResponse.dashboard!.offerProduct!.viewAll!)
    ...
    Widget _suggested() {
      return DashboardComponent5(
        ...
        onTap: () {
          ViewAllScreen(builderResponse.dashboard!.suggestionProduct!.title,
                  isNewest: true)
              .launch(context);
        },
      );
    ...
    Widget _youMayLike() {
      return DashboardComponent5(
        ...
        onTap: () {
          ViewAllScreen(builderResponse.dashboard!.youMayLikeProduct!.title,
                  isNewest: true)
              .launch(context);
        },
      );
      ...
      children: [
        ListView(
          ...
          children: [
              ...
              itemBuilder: (_, index) {
                if (builderResponse.dashboard!.sorting![index] == 'slider') {
                  ...
                  return _newProduct()
                    ...
                    'vendor') {
                  return mVendor5Widget(
                          context,
                          mVendorModel,
                          builderResponse.dashboard!.vendor!.title,
                  ...
                  return _featureProduct()
                      .visible(
                          builderResponse.dashboard!.featureProduct!.enable!)
                      .paddingTop(30);
                } else if (builderResponse.dashboard!.sorting![index] ==
                    'deal_of_the_day') {
                  ...
                  return _bestSelling()
                      .visible(
                          builderResponse.dashboard!.bestSaleProduct!.enable!)
                      .paddingTop(30);
                } else if (builderResponse.dashboard!.sorting![index] ==
                    'sale_product') {
                  return _saleProduct()
                  ...
                  return _suggested()
                      .visible(
                          builderResponse.dashboard!.suggestionProduct!.enable!)
                      .paddingTop(8);
                } else if (builderResponse.dashboard!.sorting![index] ==
                    'you_may_like') {
                  return _youMayLike()
            ...
            Image.asset(ic_christmas_tag,
                fit: BoxFit.fitWidth, width: context.width(), height: 160),
            Image.asset(ic_christmas_bottom,
                fit: BoxFit.fitWidth, width: context.width())
          ],
        )
      ],
    );
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(appLocalization.translate('app_name')!,
