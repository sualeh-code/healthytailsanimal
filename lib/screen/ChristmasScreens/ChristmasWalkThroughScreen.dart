...
class ChristmasWalkThroughScreen extends StatefulWidget {
  ...
  @override
  ChristmasWalkThroughScreenState createState() =>
      ChristmasWalkThroughScreenState();
}

class ChristmasWalkThroughScreenState
    extends State<ChristmasWalkThroughScreen> {
            ...
            Column(
              ...
              children: [
                ...
                AnimatedCrossFade(
                  ...
                  crossFadeState: position == (mWalkList.length - 1)
