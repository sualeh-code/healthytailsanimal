                            ...
                            itemBuilder: (context) => [
                              PopupMenuItem(
                                  ...
                                  child: Text(appLocalization
                                      .translate("lbl_update")!)),
                              PopupMenuItem(
                                  value: 2,
                                  child: Text(appLocalization
                                      .translate("lbl_delete")!)),
                            ],
                            initialValue: 0,
        ...
        body: BodyCornerWidget(
          child: Stack(
            children: <Widget>[
                  ...
                  : Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          20.height,
                          Text(appLocalization.translate('lbl_no_review')!,
                            ...
                            child: AppButton(
                                ...
                                onTap: () {
                                  if (mIsLoggedIn == true) {
                                    ...
                                    toast(
                                        "Guest user can't authorized for this action");
                                  }
                                }),
                          ),
                        ],
              ...
              Text(mErrorMsg, style: primaryTextStyle())
                  .visible(!appStore.isLoading)
                  .center()
