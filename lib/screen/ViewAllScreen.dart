                  ...
                  mCategoryModel[i].image != null
                      ? CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                              mCategoryModel[i].image!.src.validate()),
                          radius: 35)
                      : CircleAvatar(
                          backgroundColor: context.cardColor,
        ...
        return _productListWidget(mProductModel[index], context).onTap(() {
          if (getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) == 1) {
            ProductDetailScreen1(mProId: mProductModel[index].id)
                .launch(context);
          } else if (getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) ==
              2) {
            ProductDetailScreen2(mProId: mProductModel[index].id)
                .launch(context);
          } else if (getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) ==
              3) {
            ProductDetailScreen3(mProId: mProductModel[index].id)
                .launch(context);
          } else {
            ProductDetailScreen1(mProId: mProductModel[index].id)
                .launch(context);
          ...
          child: Column(
            children: [
              ...
              InkWell(
                ...
                ).visible(appStore.count! > 0 && cartStore.cartTotalAmount > 0),
              )
            ],
          ),
        );
