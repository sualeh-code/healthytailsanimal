  ...
  Widget build(BuildContext context) {
      ...
      return Countdown(
        ...
        builder: (BuildContext ctx, Duration? remaining) {
          ...
          return Container(
            ...
            width: context.width(),
            child: Text(
                    appLocalization!.translate('lbl_sale_end_in')! +
                        " " +
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar:
            mTop(context, widget.title, showBack: true) as PreferredSizeWidget?,
        body: BodyCornerWidget(
          child: Stack(
            children: [
              ...
              Center(child: EmptyScreen()).visible(
                  errorMsg.isNotEmpty && !isLoading && mProductModel.isEmpty),
            ],
          ),
        ),
      ),
