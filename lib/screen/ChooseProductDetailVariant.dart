...
class ChooseProductDetailVariant extends StatefulWidget {
  ...
  @override
  ChooseProductDetailVariantState createState() =>
      ChooseProductDetailVariantState();
}

class ChooseProductDetailVariantState
    extends State<ChooseProductDetailVariant> {
  @override
  void initState() {
    super.initState();
    init();
  ...
  Widget itemWidget(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) == code
                ? primaryColor!
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          Image.asset('images/mightystore/productDetail_$code.jpg',
                  fit: BoxFit.cover, alignment: Alignment.topCenter)
              .cornerRadiusWithClipRRect(8),
          AnimatedContainer(
                  duration: Duration(milliseconds: 800),
                  color: getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) ==
                          code
                      ? transparentColor
                      : Colors.black45)
              .cornerRadiusWithClipRRect(8),
          AnimatedContainer(
            ...
            child: Text(title.validate(),
                style: boldTextStyle(
                    color:
                        getIntAsync(DASHBOARD_PAGE_VARIANT, defaultValue: 1) ==
                                code
                            ? white
                            : textPrimaryColor)),
            decoration: BoxDecoration(
                color:
                    getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) == code
