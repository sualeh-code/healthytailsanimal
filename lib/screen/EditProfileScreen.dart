...
//   CountryState? selectedShippingState;
  ...
  Future<void> getCustomerInfo() async {
    ...
    if (getStringAsync(GUEST_USER_DATA).isNotEmpty) {
      CustomerData mUserData =
          CustomerData.fromJson(jsonDecode(getStringAsync(GUEST_USER_DATA)));
  ...
  setCountryStatePrefData(List<dynamic> value) {
    var txtBillingCountry, txtBillingState;
    // ,
    // txtShippingCountry,
    // txtShippingState;
    if (getStringAsync(GUEST_USER_DATA).isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    saveUser() async {
      if (formKey.currentState!.validate()) {
        ...
        mBilling.postcode = "";
        mBilling.state = "";
        mBilling.address2 = "None";
        mBilling.company = "None";
        mBilling.lastName = "";
        ...
        mShipping.firstName = txtBillingFirstName.text;
        // mShipping.lastName = txtBillingLastName.text;
        // mShipping.company = txtBillingCompanyName.text;
        mShipping.address1 = txtBillingAddress1.text;
        // mShipping.address2 = txtBillingAddress2.text;
        mShipping.city = txtBillingCity.text;
        // mShipping.postcode = txtBillingPinCode.text;
        // mShipping.country = selectedBillingCountry != null
        //     ? selectedBillingCountry!.code.toString()
        //     : "";
        // mShipping.state = selectedBillingState != null
        //     ? selectedBillingState!.code.toString()
        //     : "";
        mShipping.country = "";
        mShipping.postcode = "";
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    8.height,
                    Text(appLocalization.translate("lbl_add_personal_detail")!,
                      ...
                      children: [
                        Expanded(
                          child: SimpleEditText(
                            ...
                            hintText:
                                appLocalization.translate('hint_first_name'),
                            validator: (String? v) {
                              if (v!.trim().isEmpty)
                    ...
                    Text(appLocalization.translate("lbl_add_billing_address")!,
                        style: boldTextStyle(size: 18)),
                    16.height,
                    Column(
                      children: [
                    ...
                    //         validator: (String? v) {
                    //           if (v!.trim().isEmpty)
                    //             return appLocalization.translate('hint_city')! +
                    //                 (' ') +
                    //                 appLocalization
                    //                     .translate('error_field_required')!;
                    //         },
                    ...
                    //             shippingStateList.clear();
                    //             shippingStateList
                    //                 .addAll(selectedShippingCountry!.states!);
                    //             selectedShippingState =
                    //                 selectedShippingCountry!.states!.isNotEmpty
                    //                     ? shippingStateList[0]
                    //                     : null;
                    //           });
                    //         },
