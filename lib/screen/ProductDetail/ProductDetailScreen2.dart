            ...
            ? Column(
                ...
                children: [
                  Text(productDetailNew!.attributes![i].name,
                          style: primaryTextStyle())
                      .visible(
                          productDetailNew!.attributes![i].options != null),
                  4.height,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(product[i].name!,
                              style: primaryTextStyle(size: 12), maxLines: 2),
                          8.height,
                          Row(
                            children: [
                              PriceWidget(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      commonCacheImageWidget(product[i].images![0].src,
                              height: 105, width: 85, fit: BoxFit.cover)
                          .cornerRadiusWithClipRRect(8),
                    ],
                  ).paddingAll(8),
                );
                  ...
                  Text(
                      wishListStore.isItemInWishlist(productDetailNew!.id!) ==
                          ...
                          ? appLocalization!
                              ...
                              .toUpperCase()
                          : appLocalization!
                              .translate('lbl_wishlisted')!
                              .toUpperCase(),
                      textAlign: TextAlign.center,
                      style: boldTextStyle(
                          color: primaryColor, wordSpacing: 2, size: 14)),
                ],
              ),
            ),
            ...
            if (productDetailNew!.inStock == true) {
              if (mIsExternalProduct) {
                WebViewExternalProductScreen(
                        ...
                        title:
                            appLocalization!.translate('lbl_external_product'))
                    .launch(context);
              } else if (!getBoolAsync(IS_LOGGED_IN)) {
                SignInScreen().launch(context,
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ).paddingOnly(left: 12, bottom: 8).visible(
                ...
                if (productDetailNew!.store != null)
                  Container(
                    ...
                    child: Row(
                      children: [
                        Text(appLocalization!.translate('lbl_trade_in')!,
                                style: primaryTextStyle())
                      ...
                      productDetailNew!.store!.shopName.validate().isNotEmpty),
                if (productDetailNew!.onSale!)
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    productDetailNew!.shortDescription.toString().isNotEmpty),
                          ...
                          (e) {
                            return Container(
                              ...
                              decoration: boxDecorationWithRoundedCorners(
                                  backgroundColor: context.cardColor,
                                  border: Border.all(
                                      width: 0.1, color: context.iconColor)),
