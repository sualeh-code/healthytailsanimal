    ...
    await getProductDetail(widget.mProId).then((res) {
      ...
      setState(() {
        ...
        if (mProducts.isNotEmpty) {
          ...
          if (productDetailNew!.type == "variable" ||
              productDetailNew!.type == "variation") {
          ...
          if (productDetailNew!.woofVideoEmbed != null) {
            if (productDetailNew!.woofVideoEmbed!.url != '') {
              if (productDetailNew!.woofVideoEmbed!.url
                  .validate()
                  .contains(VideoTypeYouTube)) {
                videoType = VideoTypeYouTube;
              } else if (productDetailNew!.woofVideoEmbed!.url
                  .validate()
                  .contains(VideoTypeIFrame)) {
              ...
              productImg.add(
                Stack(
                  ...
                  children: [
                    ...
                    productDetailNew!.woofVideoEmbed!.url != null
                  ...
                  print(productDetailNew!.woofVideoEmbed!.url);
                  if (productDetailNew!.woofVideoEmbed!.url != null)
                    VideoPlayDialog(data: productDetailNew!.woofVideoEmbed)
                        .launch(context);
                }),
              );
            }
  ...
  Widget mSpecialPrice(String? value) {
    if (productDetailNew != null) {
      if (productDetailNew!.dateOnSaleFrom != "") {
        var endTime =
            productDetailNew!.dateOnSaleTo.toString() + " 23:59:59.000";
      ...
      itemBuilder: (context, i) {
        return productDetailNew!.attributes![i].options != null
            ? Row(
                ...
                children: [
                  Text(productDetailNew!.attributes![i].name + " : ",
                          style: boldTextStyle(size: 14))
                      .visible(
                          productDetailNew!.attributes![i].options!.isNotEmpty),
                  4.height,
                  Text(getAllAttribute(productDetailNew!.attributes![i]),
  ...
  Widget build(BuildContext context) {
        ...
        if (productDetailNew!.dateOnSaleFrom != "") {
          return Column(
            ...
            children: [
              ...
              Text(
                      appLocalization!
                          .translate('lbl_upcoming_sale_on_this_item')!,
                      style: boldTextStyle())
                  .paddingAll(16),
              Container(
                  ...
                  child: Text(
                    appLocalization.translate('lbl_sale_start_from')! +
                        ...
                        appLocalization.translate(
                            'lbl_ge_amazing_discounts_on_the_products')!,
      ...
      return Column(
        ...
        children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          5.height,
                          Text(parseHtmlString(mReviewModel[index].review),
                              style: primaryTextStyle()),
                        ],
                      ).expand(),
                    ],
          ...
          Row(
            ...
            children: [
              Text(appLocalization.translate("lbl_view_all_customer_review")!,
              ...
              .paddingAll(16)
              .visible(mReviewModel.length >= 5 &&
                  productDetailNew!.reviewsAllowed == true),
        ],
      );
    }
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, i) {
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Stack(
                          children: [
                            commonCacheImageWidget(product[i].images!.first.src,
                                    height: 150,
                                    width: productWidth,
                                    fit: BoxFit.cover)
                  ...
                  if (getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) ==
                      1) {
              ...
              children: [
                PageView(
                  children: productImg1.map((i) {
                    return commonCacheImageWidget(i.validate(),
                            fit: BoxFit.cover,
                            height: 400,
                            width: double.infinity)
                        .cornerRadiusWithClipRRectOnly(
                        ...
                        .onTap(() {
                      ZoomImageScreen(
                              mImgList: productDetailNew!.images,
                              ind: selectIndex)
                          .launch(context);
                    });
                  }).toList(),
            ...
            return GestureDetector(
              onTap: () {
                if (productDetailNew!.type! == 'external') {
                  toast(
                      appLocalization!.translate('lbl_external_wishlist_msg')!);
                } else {
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    wishListStore.isItemInWishlist(productDetailNew!.id!) ==
                            false
              ...
              child: Text(
                productDetailNew!.inStock! == true
                    ? productDetailNew!.type! == 'external'
                        ? productDetailNew!.buttonText!
                        : cartStore
                                .isItemInCart(productDetailNew!.id.validate())
                            ? appLocalization!
                ...
                children: [
                  PriceWidget(
                      price: productDetailNew!.salePrice.toString().isNotEmpty
                          ? double.parse(productDetailNew!.salePrice.toString())
                              .toStringAsFixed(2)
                          : double.parse(
                                  productDetailNew!.price.validate().toString())
                              .toStringAsFixed(2),
                      size: 18,
                      color: primaryColor),
                  PriceWidget(
            ...
            return Row(
              children: [
                Text(appLocalization!.translate('lbl_you_saved')! + " ",
                    style: secondaryTextStyle(size: 16, color: Colors.green)),
                PriceWidget(
            ...
            child: Column(
              ...
              children: [
                productDetailNew!.images!.isNotEmpty
                    ? productDetailNew!.woofVideoEmbed != null &&
                            productDetailNew!.woofVideoEmbed!.url != ''
                        ? videoSlider
                        : imgSlider
                    : SizedBox(),
                Container(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                                  ...
                                  children: [
                                    ...
                                    WidgetSpan(
                                        child: Icon(Icons.star,
                                            size: 14, color: yellowColor)),
                                  ],
                                ),
                              ),
                            ),
                          ).onTap(() async {
                            final bool result = await ReviewScreen(
                          ...
                          .paddingOnly(top: 4, left: 16, right: 8, bottom: 4)
                          .visible(
                              !productDetailNew!.type!.contains("grouped")),
                      mSavePrice().visible(
                          !productDetailNew!.type!.contains("grouped")),
                        ...
                        Divider(
                                ...
                                color: appStore.isDarkMode!
                                    ...
                                    : Theme.of(context)
                                        ...
                                        .headline4!
                                        .color)
                            .visible(productDetailNew!.store!.shopName
                                .validate()
                                .isNotEmpty),
                      if (productDetailNew!.store != null)
                        Row(
                          children: [
                            ...
                            8.width,
                            Text(
                                    productDetailNew!.store!.shopName != null
                                        ? productDetailNew!.store!.shopName!
                                        : '',
                                    style: boldTextStyle(color: primaryColor))
                                .onTap(() {
                              VendorProfileScreen(
                                      mVendorId: productDetailNew!.store!.id)
                                  .launch(context);
                            })
                          ],
                        )
                      ...
                      Divider(
                              ...
                              color: appStore.isDarkMode!
                                  ...
                                  : Theme.of(context)
                                      ...
                                      .headline4!
                                      .color)
                          .visible(productDetailNew!.onSale! &&
                              productDetailNew!.dateOnSaleFrom!.isNotEmpty),
                      if (productDetailNew!.onSale!)
                        productDetailNew!.dateOnSaleFrom!.isNotEmpty
                            ? mSpecialPrice(
                      ...
                      Text(appLocalization!.translate('lbl_product_details')!,
                              style: boldTextStyle())
                          .paddingOnly(top: 4, left: 16, right: 16)
                          .visible(productDetailNew!.description!.isNotEmpty),
                      HtmlWidget(postContent: productDetailNew!.description)
                          .paddingOnly(left: 10)
                          .visible(productDetailNew!.description!.isNotEmpty),
                      if (productDetailNew!.attributes != null)
                      ...
                      Divider(
                              ...
                              color: appStore.isDarkMode!
                                  ...
                                  : Theme.of(context)
                                      ...
                                      .headline4!
                                      .color)
                          .visible(productDetailNew!.shortDescription
                              .toString()
                              .isNotEmpty),
                      Text(appLocalization.translate('lbl_short_description')!,
                          ...
                          .visible(productDetailNew!.shortDescription
                              ...
                              .isNotEmpty),
                      HtmlWidget(
                              postContent: productDetailNew!.shortDescription)
                      ...
                      Divider(
                              ...
                              color: appStore.isDarkMode!
                                  ...
                                  : Theme.of(context)
                                      ...
                                      .headline4!
                                      .color)
                          .visible(productDetailNew!.categories != null &&
                              productDetailNew!.categories!.isNotEmpty),
                      ...
                      Divider(
                              ...
                              color: appStore.isDarkMode!
                                  ...
                                  : Theme.of(context)
                                      ...
                                      .headline4!
                                      .color)
                          .visible(productDetailNew!.upSellId!.isNotEmpty),
                      if (productDetailNew!.upSellIds != null)
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text(productDetailNew != null ? productDetailNew!.name! : ' ',
      ...
      bottomNavigationBar: Container(
              ...
              child: Row(
                children: [
                  mCartData.expand(flex: 8),
                  16.width,
                  mFavourite.expand(flex: 1),
                ],
              ).paddingOnly(top: 8, bottom: 8, right: 16, left: 16).visible(
                  productDetailNew != null &&
                      productDetailNew!.type != 'grouped'))
