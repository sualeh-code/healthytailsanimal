  ...
  Widget build(BuildContext context) {
      ...
      return Column(
        ...
        children: [
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  RatingBar.builder(
                                    initialRating:
                                        mReviewModel[index].rating!.toDouble(),
                                    minRating: 1,
          ...
          Row(
            ...
            children: [
              Text(appLocalization.translate("lbl_view_all_review")!,
    ...
    Widget upSaleProductList(List<UpsellId> product) {
      ...
      return Column(
        ...
        children: <Widget>[
          8.height,
          Text(appLocalization!.translate('lbl_like')!, style: boldTextStyle())
              .paddingLeft(12.toDouble()),
          Container(
    ...
    Widget mGroupAttribute(List<ProductDetailResponse> product) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text(appLocalization!.translate('lbl_product_Involve')!,
                  style: boldTextStyle())
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: boxDecorationWithRoundedCorners(
                                  borderRadius: radius(8),
                                  backgroundColor: product[i].inStock == true
                                      ? primaryColor!
                                      : white,
                  ...
                  children: productImg1.map((i) {
                    return commonCacheImageWidget(i.validate(),
                        ...
                        .cornerRadiusWithClipRRectOnly(
                            topLeft: 20, topRight: 20)
                        .onTap(() {
                      ZoomImageScreen(mImgList: productDetailNew!.images!)
                          .launch(context);
                    });
                  }).toList(),
                  controller: _pageController,
                  ...
                  Text(
                    productDetailNew!.inStock! == true
                        ? productDetailNew!.type! == 'external'
                            ...
                            : cartStore.isItemInCart(
                                    productDetailNew!.id.validate())
                                ? appLocalization!
                                    .translate('lbl_remove_cart')!
                                    .toUpperCase()
                                : appLocalization!
                                    .translate('lbl_add_to_basket')!
                                    .toUpperCase()
                        : appLocalization!
                            .translate('lbl_sold_out')!
                            .toUpperCase(),
                    textAlign: TextAlign.center,
                    style:
                        boldTextStyle(color: white, wordSpacing: 1, size: 14),
                  ),
                ],
              ),
            ),
    ...
    final mPrice = productDetailNew != null
        ? productDetailNew!.onSale == true
            ? Row(
                children: [
                  Text(appLocalization!.translate('lbl_mrp')! + " : ",
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                                    ...
                                    children: [
                                      ...
                                      WidgetSpan(
                                          child: Icon(Icons.star,
                                              size: 14, color: bgCardColor)),
                                    ],
                                  ),
                                ),
                              ),
                            ).onTap(() async {
                              final double? result = await ReviewScreen(
                        ...
                        ).paddingOnly(top: 4, left: 12).visible(
                        ...
                        if (productDetailNew!.type == "variable" ||
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text(appLocalization!.translate('lbl_possible')!,
                                      style: boldTextStyle())
                              ...
                              Wrap(
                                ...
                                children: mProductOptions.map((e) {
                                  ...
                                  return Container(
                                    ...
                                    child: Text(e!,
                                        style: secondaryTextStyle(
                                            color: selectedOptionAvailableIn ==
                                                    index
                                                ? black
                                                : textSecondaryColour)),
                                  ).onTap(() {
                        ...
                        HtmlWidget(
                                postContent: productDetailNew!.description
                                    .toString()
                                    .trim())
                        ...
                        mSetAttribute()
                            .paddingBottom(8)
                            .visible(productDetailNew!.attributes!.isNotEmpty),
                        Text(
                                appLocalization
                        ...
                        HtmlWidget(
                            ...
                            .visible(productDetailNew!.shortDescription
                                .toString()
                                .isNotEmpty),
                        Text(appLocalization.translate('lbl_shop_category')!,
                                style: boldTextStyle())
                            .paddingOnly(left: 12, right: 12, top: 8),
                        4.height,
                        Wrap(
