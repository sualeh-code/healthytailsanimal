...
class HomeScreen4State extends State<HomeScreen4> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget availableOfferAndDeal(String title, List<ProductResponse> product) {
      return Stack(
        children: [
          Image.asset(ic_halloween_background,
              height: 400, width: context.width(), fit: BoxFit.cover),
          Column(
                        ...
                        Stack(
                          ...
                          children: [
                            CircleAvatar(
                                ...
                                backgroundImage:
                                    AssetImage(ic_halloween_category),
                                radius: 36),
                        ...
                        children: [
                          Container(
                            decoration: boxDecorationWithRoundedCorners(
                                border: Border.all(
                                    color: mHalloweenYellow, width: 16),
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Text(i.title!,
                                    style:
                                        boldTextStyle(color: white, size: 24)),
                                2.height,
                                Text(
                                    appLocalization
                                            .translate('lbl_sale_start_from')! +
                                        " " +
                                        i.startDate.validate() +
                                        " to " +
                                        i.endDate.validate(),
    ...
    Widget mVendor4Widget(BuildContext context,
        List<VendorResponse> mVendorModel, var title, var all,
        {size: 16}) {
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Image.asset(ic_halloween_pumpkin_gif,
                            ...
                            children: [
                              WidgetSpan(
                                  child: Icon(Icons.add,
                                      size: 14, color: white.withOpacity(0.4))),
                              TextSpan(
                                  text: all,
                                  style: secondaryTextStyle(
                                      size: 14, color: white.withOpacity(0.4))),
