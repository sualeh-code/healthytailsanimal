...
class HalloweenWalkThroughScreen extends StatefulWidget {
  ...
  @override
  HalloweenWalkThroughScreenState createState() =>
      HalloweenWalkThroughScreenState();
}

class HalloweenWalkThroughScreenState
    extends State<HalloweenWalkThroughScreen> {
            ...
            Stack(
              ...
              children: [
                ...
                Positioned(
                  right: 20,
                  top: 40,
                  child: Text('Skip', style: primaryTextStyle(color: white))
                      .onTap(() async {
                ...
                Column(
                  ...
                  children: [
                    Text(mWalkList[position].title!,
                        style: boldTextStyle(size: 24, color: white)),
                    16.height,
                    Text(mWalkList[position].desc!,
                        style: primaryTextStyle(color: white.withOpacity(0.5)),
