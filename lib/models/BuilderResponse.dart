...
class Dashboard {
  ...
  Dashboard.fromJson(Map<String, dynamic> json) {
    ...
    newProduct = json['newProduct'] != null
        ? new NewProduct.fromJson(json['newProduct'])
        : null;
    featureProduct = json['feature'] != null
        ? new NewProduct.fromJson(json['feature'])
        : null;
    saleProduct = json['saleProduct'] != null
        ? new NewProduct.fromJson(json['saleProduct'])
        : null;
    dealOfTheDay = json['dealOfTheDay'] != null
        ? new NewProduct.fromJson(json['dealOfTheDay'])
        : null;
    bestSaleProduct = json['bestSaleProduct'] != null
        ? new NewProduct.fromJson(json['bestSaleProduct'])
        : null;
    offerProduct = json['offerProduct'] != null
        ? new NewProduct.fromJson(json['offerProduct'])
        : null;
    suggestionProduct = json['suggestionProduct'] != null
        ? new NewProduct.fromJson(json['suggestionProduct'])
        : null;
    vendor =
        json['vendor'] != null ? new NewProduct.fromJson(json['vendor']) : null;
    youMayLikeProduct = json['youMayLikeProduct'] != null
        ? new NewProduct.fromJson(json['youMayLikeProduct'])
        : null;
