...
class DashBoard4VendorComponent extends StatefulWidget {
  ...
  @override
  DashBoard4VendorComponentState createState() =>
      DashBoard4VendorComponentState();
}
...
Widget getDashboard4VendorWidget(VendorResponse vendor, BuildContext context,
    {double width = 250}) {
  ...
  return Container(
    ...
    child: Stack(
      children: [
        Image.asset(ic_halloween_vendor,
            height: 285, width: width, fit: BoxFit.fitWidth),
        Stack(
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  commonCacheImageWidget(img,
                          height: 200, width: width, fit: BoxFit.fill)
                      .paddingAll(4),
                  4.height,
                  Text(vendor.storeName!, style: boldTextStyle(color: white))
                      .center(),
                  4.height,
                  RichText(
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                            text: appLocalization.translate('lbl_light'),
