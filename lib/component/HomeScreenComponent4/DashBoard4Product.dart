...
class DashBoard4Product extends StatefulWidget {
  ...
  DashBoard4Product({Key? key, this.width, this.mProductModel})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        child: Stack(
          children: [
            Image.asset(ic_halloween_product_frame1,
                height: 265, fit: BoxFit.fill, width: widget.width),
            Container(
              width: widget.width,
                  ...
                  Stack(
                    ...
                    children: [
                      commonCacheImageWidget(img.validate(),
                          height: 190, width: widget.width, fit: BoxFit.cover),
