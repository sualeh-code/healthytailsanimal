...
class DashBoard3Product extends StatefulWidget {
  ...
  DashBoard3Product({Key? key, this.width, this.mProductModel})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: boxDecorationWithShadow(boxShadow: [
          BoxShadow(
              blurRadius: 0.3, spreadRadius: 0.2, color: gray.withOpacity(0.3))
