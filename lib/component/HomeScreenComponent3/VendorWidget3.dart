...
Widget getVendorDashBoard3Widget(VendorResponse vendor, BuildContext context,
    {double width = 260}) {
  ...
  return Container(
    ...
    decoration: BoxDecoration(
        border:
            Border.all(width: 0.1, color: appStore.isDarkMode! ? white : gray)),
...
Widget mVendorDashBoard3Widget(
              ...
              children: [
                Text(title,
                    style: GoogleFonts.alata(
                        fontSize: 23, color: context.iconColor)),
                4.height,
                SizedBox(
                    width: context.width() * 0.22,
                    child: DashedRect(gap: 3, color: context.iconColor)),
              ],
            ),
            4.height,
