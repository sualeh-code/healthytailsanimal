...
Widget getVendorDashBoard2Widget(VendorResponse vendor, BuildContext context,
    {double width = 260}) {
    ...
    child: Stack(
      ...
      children: [
        ClipRRect(
            ...
            child: commonCacheImageWidget(img,
                height: 150, width: width, fit: BoxFit.fill)),
        Positioned(
          bottom: -50,
          child: Container(
...
Widget mVendorDashBoard2Widget(
