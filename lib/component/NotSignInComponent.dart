...
class WishListNotSignInComponent extends StatefulWidget {
  ...
  @override
  WishListNotSignInComponentState createState() =>
      WishListNotSignInComponentState();
}

class WishListNotSignInComponentState
    extends State<WishListNotSignInComponent> {
  @override
  void initState() {
    super.initState();
    init();
    ...
    return Column(
      ...
      children: [
        widget.isWishlist == true
            ? Icon(MaterialIcons.favorite_outline,
        ...
        Text(appLocalization.translate("lbl_wishlist_msg")!,
                ...
                textAlign: TextAlign.center)
            .paddingOnly(left: 20, right: 20)
            .visible(widget.isWishlist == true),
        30.height,
        AppButton(
                width: context.width(),
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: GestureDetector(
                child: Text(appLocalization.translate('lbl_sign_up_link')!,
