...
class AddMoneyComponent extends StatefulWidget {
  ...
  AddMoneyComponent({Key? key, this.onCall, this.mWalletConfigurationResponse})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: boxDecorationWithRoundedCorners(
          borderRadius: radius(10), backgroundColor: context.cardColor),
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: [
                Text(appLocalization.translate('lbl_add_money')!.toUpperCase(),
                    style: boldTextStyle()),
                IconButton(
                  onPressed: () {
                    finish(context, true);
            ...
            AppButton(
                ...
                color: primaryColor,
                onTap: () {
                  var min = widget.mWalletConfigurationResponse!.minTopupAmount
                      .toString()
                      .toDouble();
                  var max = widget.mWalletConfigurationResponse!.maxTopupAmount
                      .toString()
                      .toDouble();
