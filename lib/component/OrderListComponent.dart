...
Widget orderListWidget(
    context, List<OrderResponse> mOrderModel, Function(int index) onCall) {
                        ...
                        if (mOrderModel[i].lineItems!.length > 1)
                          Column(
                            ...
                            children: [
                              ...
                              4.height,
                              Text(appLocalization.translate("lbl_more_item")!,
                        ...
                        children: [
                          PriceWidget(
                                  ...
                                  color: Theme.of(context)
                                      ...
                                      .color)
                              .expand(),
                          Text(mOrderModel[i].status!.toUpperCase().toString(),
                              style: boldTextStyle(
