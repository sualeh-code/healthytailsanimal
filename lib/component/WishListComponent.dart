...
class WishListComponent extends StatefulWidget {
  ...
  WishListComponent({Key? key, this.mWishListModel, required this.onClick})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Stack(
            ...
            children: [
              widget.mWishListModel!.full == null
                  ? widget.mWishListModel!.gallery!.isEmpty
                      ? Image.asset(splash,
                          width: context.width(),
                          height: 150,
                          fit: BoxFit.cover)
                      : commonCacheImageWidget(
                              ...
                              widget.mWishListModel!.gallery![0].validate(),
                              height: 150,
                              width: context.width(),
                              fit: BoxFit.cover)
                  ...
                  : commonCacheImageWidget(
                          // null,
                          widget.mWishListModel!.full.validate(),
                          height: 150,
                          width: context.width(),
                          fit: BoxFit.cover)
                  ...
                  Container(
                    ...
                    showConfirmDialogCustom(
                      ...
                      onAccept: (c) async {
                        ...
                        log("value");
                        await wishListStore
                            .addToWishList(widget.mWishListModel!);
                        setState(() {});
                      },
                    );
                  })
          ...
          Column(
            ...
            children: [
              Text(widget.mWishListModel!.name!,
              ...
              Row(
                children: <Widget>[
                  PriceWidget(
                      price: widget.mWishListModel!.salePrice!.isNotEmpty
                          ? widget.mWishListModel!.salePrice.toString()
                          : widget.mWishListModel!.price.toString(),
                      size: 16,
                      color: primaryColor),
                  4.width,
                  PriceWidget(
                          price: widget.mWishListModel!.regularPrice.toString(),
                          size: 14,
                          color: Theme.of(context).textTheme.subtitle1!.color,
                          isLineThroughEnabled: true)
                      .visible(widget.mWishListModel!.salePrice
                          .validate()
                          .isNotEmpty),
                ],
              ).paddingOnly(left: 8, right: 8),
              ...
              if (widget.mWishListModel!.inStock == false)
                Text(appLocalization.translate('lbl_sold_out')!,
                        style: boldTextStyle(color: greyColor))
                    .paddingOnly(top: 6, bottom: 10)
                    .center()
              else
                Text(
                        cartStore.isItemInCart(
                                widget.mWishListModel!.proId.validate())
                            ? appLocalization
