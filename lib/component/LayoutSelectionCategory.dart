...
class LayoutSelectionCategory extends StatefulWidget {
  ...
  @override
  _LayoutSelectionCategoryState createState() =>
      _LayoutSelectionCategoryState();
}
...
class _LayoutSelectionCategoryState extends State<LayoutSelectionCategory> {
  ...
  init() async {
    ...
    select.add(LayoutTypesSelection(
        image: Icon(Icons.list_rounded), isSelected: false));
    select.add(LayoutTypesSelection(
        image: Icon(Ionicons.ios_grid_outline), isSelected: false));
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(appLocalization.translate('lbl_layout')!,
                ...
                return Container(
                  ...
                  child: Container(
                    ...
                    decoration: boxDecorationWithRoundedCorners(
                        ...
                        backgroundColor: select[index].isSelected!
                            ? Colors.black54.withOpacity(0.2)
                            : Colors.white.withOpacity(0.2)),
                    child: IconButton(
                      icon: select[index].image!,
                      color: select[index].isSelected!
                          ? Colors.black
                          : Colors.white,
                      onPressed: () async {
                        init();
