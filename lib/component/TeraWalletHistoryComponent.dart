...
class TeraWalletHistoryComponent extends StatefulWidget {
  ...
  @override
  TeraWalletHistoryComponentState createState() =>
      TeraWalletHistoryComponentState();
}

class TeraWalletHistoryComponentState
    extends State<TeraWalletHistoryComponent> {
    ...
    return Row(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Text(widget.data.details!.toString(), style: primaryTextStyle())
                .visible(widget.data.details.toString().isNotEmpty),
            6.height,
            Text(reviewConvertDate(widget.data.date!.toString()),
        ...
        Row(
          children: [
            ...
            Text(getStringAsync(DEFAULT_CURRENCY) + num1.toString(),
                style: boldTextStyle(
