...
class DashBoard5VendorComponent extends StatefulWidget {
  ...
  @override
  DashBoard5VendorComponentState createState() =>
      DashBoard5VendorComponentState();
}
    ...
    return HorizontalList(
      ...
      itemBuilder: (context, i) {
        return GestureDetector(
          onTap: () {
            VendorProfileScreen(mVendorId: widget.product[i].id)
                .launch(context);
          },
...
Widget getDashboard5VendorWidget(VendorResponse vendor, BuildContext context,
    {double width = 300}) {
  ...
  return Container(
    ...
    child: Stack(
      children: [
        Image.asset(ic_christmas_vendor,
                height: 250, width: width, fit: BoxFit.fitWidth)
          ...
          child: Column(
            ...
            children: [
              commonCacheImageWidget(img,
                      height: 140, width: width, fit: BoxFit.fill)
                  .cornerRadiusWithClipRRect(8)
                  .paddingAll(4),
              4.height,
              ...
              RichText(
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                        text: appLocalization.translate('lbl_explore')!,
                        style:
                            secondaryTextStyle(size: 14, color: Colors.black)),
                  ],
                ),
              ).center()
            ],
          ...
          children: [
            Column(
              children: [
                ...
                Text(all,
                    style:
                        secondaryTextStyle(color: mChristmasColor, size: 14)),
              ],
            ).onTap(() {
